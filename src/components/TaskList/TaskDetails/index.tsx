        ...
        <div className="bg-white rounded-lg shadow-xl overflow-hidden">
          ...
          <div className="p-8">
            ...
            <div className="mt-8 pt-6 border-t flex justify-end gap-3">
              ...
              <button
                onClick={() => navigate(`/tarefa/editar/${id}`)}
                className="px-6 py-2 rounded-lg bg-blue-500 text-white font-medium hover:bg-blue-600 transition-colors flex items-center gap-2"
              >
                <svg
                  className="w-5 h-5"
                  fill="none"
